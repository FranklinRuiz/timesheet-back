...
public class TipoTrabajoServiceImpl implements TipoTrabajoService {
    ...
    @Override
    public TipoTrabajo saveTipoTrabajo(TipoTrabajo tipoTrabajo) {
        tipoTrabajo.setFlgActivo(true);
        return tipoTrabajoRepository.save(tipoTrabajo);
    }

    @Override
    public TipoTrabajo updateTipoTrabajo(TipoTrabajo tipoTrabajo) {
        tipoTrabajo.setFlgActivo(true);
        return tipoTrabajoRepository.save(tipoTrabajo);
    }

    @Override
    public Page<TipoTrabajo> listAllByPage(Pageable pageable) {
        return tipoTrabajoRepository.findByFlgActivo(true, pageable);
    }

    @Override
    public Long deleteTipoTrabajo(Long idTipoTrabajo) {
        Long rpta = 0L;
