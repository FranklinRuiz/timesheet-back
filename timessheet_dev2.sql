...
INSERT INTO `asistencia` VALUES (1,1,1,1,1,'08:00:00','18:00:00',NULL,NULL,0,1,'cristian ','2022-06-28 19:44:12',NULL,NULL),(2,2,1,1,2,'08:00:00','18:01:00',NULL,NULL,0,1,'cristian ','2022-06-28 19:44:25',NULL,NULL),(3,3,1,1,1,'08:00:00','18:07:00',NULL,NULL,0,1,'cristian ','2022-06-28 19:44:38',NULL,NULL),(4,5,1,2,1,'08:04:00','18:50:00',NULL,NULL,0,1,'cristian ','2022-06-28 19:45:06',NULL,NULL),(7,6,2,3,2,'08:02:00','18:15:00',NULL,NULL,0,1,'cristian ','2022-06-28 19:46:01',NULL,NULL),(8,7,1,3,2,'08:13:00','18:12:00',NULL,NULL,0,1,'cristian ','2022-06-28 19:46:24',NULL,NULL),(9,8,1,3,1,'08:01:00','18:00:00',NULL,NULL,0,1,'cristian ','2022-06-29 19:46:43',NULL,NULL),(10,9,1,1,1,'08:00:00','18:30:00',NULL,NULL,0,1,'cristian ','2022-06-29 19:46:53',NULL,NULL);
...
--
-- Dumping events for database 'timesheet_dev'
--
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `IndDataPersonas`(FInicio date, FFin date)
BEGIN 
	SELECT  
		...
		COUNT( CASE WHEN a.sexo = 2 AND a.flg_activo = 1 THEN 0 END) as Muejres
	FROM timesheet_dev.personas a 
    WHERE a.flg_activo = 1
	AND  DATE_FORMAT(a.date_reg, "%Y-%m-%d")  Between  FInicio and FFin;
END ;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `IndHorasPorSede`(FInicio date,FFin date )
BEGIN
		SELECT  
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `IndPersonaPorArea`( FInicio date,  FFin date)
BEGIN
	 SELECT  
...
AND  DATE_FORMAT(e.date_reg, "%Y-%m-%d")  Between  FInicio and FFin
GROUP BY a.id_area;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `RepAsistencias` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `RepAsistencias`()
BEGIN
	SELECT   
		  p.nombre_completo as empleado,
		  a.hora_entrada as hentrada,
		  a.hora_salida as hsalida
	FROM timesheet_dev.asistencia a 
	INNER JOIN timesheet_dev.empleados e on e.id_empleado = a.id_empleado 
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `RepInasistencias` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `RepInasistencias`()
BEGIN
	SELECT 
		concat(per.nombres,' ',per.apellido_paterno,' ',per.apellido_materno) as empleado,
		DATE_FORMAT(asi.date_reg,'%d/%m/%Y') as finasistencia
	from asistencia asi 
	inner join empleados emp on asi.id_empleado = emp.id_empleado
	inner join personas per on emp.id_persona = per.id_persona
	WHERE asi.hora_entrada is null and asi.hora_salida is null;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2022-07-07 21:38:10
